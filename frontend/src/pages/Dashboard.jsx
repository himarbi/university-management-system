...
const Dashboard = () => {
      ...
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="navy-card p-6 rounded-2xl flex items-center gap-5 border-l-4 border-l-[#0f224a] navy-card-hover">
            ...
            <div>
              <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Teachers</p>
              <h3 className="text-2xl font-black text-[#0f224a] mt-0.5">{totalTeachers}</h3>
            </div>
          </div>
          {/* Card 4 */}
          <div className="navy-card p-6 rounded-2xl flex items-center gap-5 border-l-4 border-l-[#0f224a] navy-card-hover">
            ...
            <div>
              ...
              <h3 className="text-2xl font-black text-[#0f224a] mt-0.5">{totalStudents}</h3>
            </div>
          </div>
        </div>
      );
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="navy-card p-6 rounded-2xl flex items-center gap-5 border-l-4 border-l-[#0f224a] navy-card-hover">
          ...
          <div>
            <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Instructors</p>
            <h3 className="text-2xl font-black text-[#0f224a] mt-0.5">
              {new Set(courses.map(c => c.teacher?.id).filter(Boolean)).size}
            </h3>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-8 select-none">
      ...
      {/* Grid: Course Listings & Activities */}
